...
const SECTION_POSES: Record<SectionId, SectionPoses> = {
  ...
  about: {
    enter: { position: [-7.5, 80, -5], rotation: [0, -1, 5] },
    stay: { position: [-7.5, 1.3, -5], rotation: [0, -1, 5] },
    leave: { position: [-7.5, -40, -5], rotation: [0, -1, 5] },
  },
  experience: {
    enter: { position: [-20, -20, -10.5], rotation: [0.8, 0.8, 0] },
    stay: { position: [0.5, 0.6, -10.5], rotation: [0.5, 0, 0.1] },
    leave: { position: [30, 6, -25.5], rotation: [0.8, 0.4, 0] },
  },
  projects: {
  ...
  tools: {
    enter: { position: [0, 150, -14], rotation: [1.2, 4.724, 0] },
    stay: { position: [0, 2.2, -14], rotation: [1.2, 4.724, 0] },
